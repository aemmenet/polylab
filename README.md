...
The [Arduino MCCI LoRaWAN LMIC library](https://docs.arduino.cc/libraries/mcci-lorawan-lmic-library) supports the SX1262 since Verion 5 but my setup for the Wio-SX1262 doesn't work yet.  
